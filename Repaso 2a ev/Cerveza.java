public class Cerveza extends Alimento implements Comparable<Alimento> {
    public Cerveza(String numReferencia, Alimentos alimentos, boolean tipoAlimento, Alimentos tipoDeAlimento, IVA ivaAplicado, String marca, double precioSinIVA) {
