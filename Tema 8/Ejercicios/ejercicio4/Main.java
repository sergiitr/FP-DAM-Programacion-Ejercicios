            ...
            do {
                switch (opcion) {
                    ...
                    case 3:
                        ...
                        correo=sc.nextLine();
                        String sqlInsert3 = "UPDATE alumnos SET email = CONCAT(LEFT(email, LOCATE('@', email) - 1), '"+correo+"');";
                        Statement stmt3 = conexion.createStatement();
                        int rowsAffected3 = stmt2.executeUpdate(sqlInsert3);
                        System.out.println("Filas afectadas: " + rowsAffected3);
                        break;
                    case 4:
                        System.out.print("Introduce DNI: ");
                        dni=sc.nextLine();
                        String sqlInsert4 = "DELETE alumnos, matricula FROM alumnos JOIN matricula ON alumnos.dni = matricula.dni WHERE alumnos.dni = '"+dni+"';";
                        break;
                    default:
